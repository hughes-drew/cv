...
tribble(
  ...
  ~entry,
  "2019-2020",
    "Referee: \\textit{The Journal of Applied 
...
```{r}
system("cp public_cv.Rmd ../../docs/public_cv.Rmd")
system("cp public_cv.tex ../../docs/public_cv.tex")
system("cp public_cv.pdf ../../docs/public_cv.pdf")
system("cp public_cv.pdf ~/Dropbox/Projects/dh_distill/public_cv.pdf")
```
